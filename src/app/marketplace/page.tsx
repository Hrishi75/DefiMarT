    ...
    <div className="min-h-screen bg-neutral-950 text-white pt-24">
      ...
      {isAuthenticated && (
        <Link
          ...
          className="fixed bottom-8 right-8 flex items-center gap-2 px-6 py-3 bg-lime-400 text-neutral-950 rounded-full font-medium shadow-lg hover:bg-lime-300 transition z-40"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
